...
class AdminController extends Controller
{
    ...
    protected function editAction()
    {
        ...
        $ent = $easyadmin['entity']['name'];

        //dump($this->container->get('security.authorization_checker')->isGranted('ROLE_ADMIN')); die;
        if (false === $this->container->get('security.authorization_checker')->isGranted('ROLE_ADMIN') AND $ent == 'Users'){
